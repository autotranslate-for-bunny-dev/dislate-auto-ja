    ...
    async execute(args, ctx) {
        ...
        try {
            ...
            switch(settings.translator) {
                case 0:
                    content = await DeepL.translate(protectedText.text, undefined, lang.value)
                    break
                case 1:
                    content = await GTranslate.translate(protectedText.text, undefined, lang.value)
                    break
            }
            ...
            return await new Promise((resolve): void => showConfirmationAlert({
                ...
                onConfirm: () => resolve({ content: translatedText }),
